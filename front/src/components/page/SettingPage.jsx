    ...
    return (
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 16px' }}>
          <StyledTypography style={{ flex: '1' }}>계정 설정</StyledTypography>
          <HomeIcon fontSize='large' onClick={gotoAlbumPage} />
        </div>
        <div style={{ padding: '16px' }}>
          <div>
            <Typography variant="h6" gutterBottom>민준님</Typography>
            {album.imageUrl ? (
          ...
          <div>
            <TextField label="Nickname" variant="outlined" fullWidth value={nickname} onChange={(e) => setNickname(e.target.value)} margin="normal" />
            <TextField label="Graduation Place" variant="outlined" fullWidth value={graduationPlace} onChange={(e) => setGraduationPlace(e.target.value)} margin="normal" />
            ...
            {albumCoverPreview && (
              <Box>
                ...
                <img src={albumCoverPreview} alt="Album Cover Preview" style={{ maxWidth: '100%', height: 'auto', marginTop: '8px' }} />
              </Box>
            )}
